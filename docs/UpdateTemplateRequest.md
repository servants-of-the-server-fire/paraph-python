...
------------ | ------------- | ------------- | -------------
**name** | **str** | New template name (omit to leave unchanged) | [optional] 
**metadata** | **Dict[str, str]** | Replace all metadata (omit to leave unchanged, key max 128 chars, value max 1024 chars) | [optional] 
**signature_placements** | [**List[SignaturePlacementInput]**](SignaturePlacementInput.md) | Replace all signature placements (omit to leave unchanged) | [optional] 
