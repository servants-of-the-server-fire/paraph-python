    ...
    def make_instance(self, include_optional) -> TemplateListResponse:
        ...
        if include_optional:
            return TemplateListResponse(
                templates = [
                    {id=d290f1ee-6c54-4b01-90e6-d701748f0851, name=Employment Agreement, metadata={category=hr}, created_at=2026-03-15T10:30:00Z, updated_at=2026-03-15T10:30:00Z}
                    ],
