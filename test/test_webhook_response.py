    ...
    def make_instance(self, include_optional) -> WebhookResponse:
        ...
        if include_optional:
            return WebhookResponse(
                webhook = {id=b1c2d3e4-5678-9abc-def0-1234567890ab, url=https://example.com/webhook, events=[request.success, signer.signed], active=true, created_at=2026-03-23T10:00:00Z, updated_at=2026-03-23T10:00:00Z}
            )
        else:
            return WebhookResponse(
        )
