...
class TestCreateRequestRequest(unittest.TestCase):
    """CreateRequestRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateRequestRequest:
        """Test CreateRequestRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateRequestRequest`
        """
    ...
    def testCreateRequestRequest(self):
        """Test CreateRequestRequest"""
