...
class TestDocumentRequestSummary(unittest.TestCase):
    """DocumentRequestSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentRequestSummary:
        """Test DocumentRequestSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentRequestSummary`
        """
        model = DocumentRequestSummary()
        if include_optional:
            return DocumentRequestSummary(
                id = '',
                template_id = '',
                title = '',
                status = 'success',
    ...
    def testDocumentRequestSummary(self):
        """Test DocumentRequestSummary"""
