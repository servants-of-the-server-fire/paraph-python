...
class TestCreateWebhook201ResponseWebhook(unittest.TestCase):
    """CreateWebhook201ResponseWebhook unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateWebhook201ResponseWebhook:
        """Test CreateWebhook201ResponseWebhook
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateWebhook201ResponseWebhook`
        """
        model = CreateWebhook201ResponseWebhook()
        if include_optional:
            return CreateWebhook201ResponseWebhook(
                id = '',
                url = '',
                events = [
                    'request.created'
    ...
    def testCreateWebhook201ResponseWebhook(self):
        """Test CreateWebhook201ResponseWebhook"""
