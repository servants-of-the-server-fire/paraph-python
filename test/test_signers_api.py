...
class TestSignersApi(unittest.TestCase):
    """SignersApi unit test stubs"""
    ...
    def test_download_signer_signature(self) -> None:
        """Test case for download_signer_signature

        Download signer signature
        """
        pass

    def test_resend_signing_link(self) -> None:
        """Test case for resend_signing_link
