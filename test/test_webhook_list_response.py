    ...
    def make_instance(self, include_optional) -> WebhookListResponse:
        ...
        if include_optional:
            return WebhookListResponse(
                webhooks = [
                    {id=b1c2d3e4-5678-9abc-def0-1234567890ab, url=https://example.com/webhook, events=[request.success, signer.signed], active=true, created_at=2026-03-23T10:00:00Z, updated_at=2026-03-23T10:00:00Z}
                    ],
