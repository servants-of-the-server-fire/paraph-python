...
class TestResendSigningLink200Response(unittest.TestCase):
    """ResendSigningLink200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResendSigningLink200Response:
        """Test ResendSigningLink200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResendSigningLink200Response`
        """
        model = ResendSigningLink200Response()
        if include_optional:
            return ResendSigningLink200Response(
                signer = {id=9b1deb4d-3b7d-4bad-9bdd-2b0d7b3dcb6d, signer_label=Employee, recipient_email=jane.doe@example.com, status=pending, expires_at=2026-04-05T10:30:00Z}
            )
        else:
            return ResendSigningLink200Response(
        )
    ...
    def testResendSigningLink200Response(self):
        """Test ResendSigningLink200Response"""
