...
class TestRequestListResponse(unittest.TestCase):
    """RequestListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequestListResponse:
        """Test RequestListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequestListResponse`
        """
        model = RequestListResponse()
        if include_optional:
            return RequestListResponse(
                requests = [
                    {id=a1b2c3d4-5678-9abc-def0-1234567890ab, template_id=d290f1ee-6c54-4b01-90e6-d701748f0851, title=Employment Agreement - Jane Doe, status=success, has_signing=true, created_at=2026-03-22T10:30:00Z, updated_at=2026-03-22T10:30:00Z}
                    ],
                list_info = {page=1, num_pages=3, num_results=48, page_size=20}
            )
        else:
            return RequestListResponse(
        )
    ...
    def testRequestListResponse(self):
        """Test RequestListResponse"""
