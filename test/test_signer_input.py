...
class TestSignerInput(unittest.TestCase):
    """SignerInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SignerInput:
        """Test SignerInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignerInput`
        """
        model = SignerInput()
        if include_optional:
            return SignerInput(
