...
class TestSignaturePlacementInput(unittest.TestCase):
    """SignaturePlacementInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SignaturePlacementInput:
        """Test SignaturePlacementInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignaturePlacementInput`
        """
        model = SignaturePlacementInput()
        if include_optional:
    ...
    def testSignaturePlacementInput(self):
        """Test SignaturePlacementInput"""
