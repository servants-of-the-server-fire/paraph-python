...
class TestRequestResponse(unittest.TestCase):
    """RequestResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequestResponse:
        """Test RequestResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequestResponse`
        """
        model = RequestResponse()
        if include_optional:
            return RequestResponse(
                request = {id=a1b2c3d4-5678-9abc-def0-1234567890ab, template_id=d290f1ee-6c54-4b01-90e6-d701748f0851, title=Employment Agreement - Jane Doe, status=success, has_signing=true, created_at=2026-03-22T10:30:00Z, updated_at=2026-03-22T10:30:00Z, inputs={employee_name=Jane Doe, start_date=2026-04-01}, signers=[{id=9b1deb4d-3b7d-4bad-9bdd-2b0d7b3dcb6d, signer_label=Employee, recipient_email=jane.doe@example.com, status=signed, expires_at=2026-04-05T10:30:00Z, signed_at=2026-03-23T14:22:00Z}]}
            )
        else:
            return RequestResponse(
        )
