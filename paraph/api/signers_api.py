...
class SignersApi:
    ...
    def download_signer_signature(
        ...
        sid: Annotated[UUID, Field(description="Signer ID")],
        ...
        _param = self._download_signer_signature_serialize(
            id=id,
            sid=sid,
    ...
    @validate_call
    def download_signer_signature_with_http_info(
        self,
        id: Annotated[UUID, Field(description="Request ID")],
        sid: Annotated[UUID, Field(description="Signer ID")],
        _request_timeout: Union[
    ...
    @validate_call
    def download_signer_signature_without_preload_content(
        self,
        id: Annotated[UUID, Field(description="Request ID")],
        sid: Annotated[UUID, Field(description="Signer ID")],
        _request_timeout: Union[
    ...
    def _download_signer_signature_serialize(
        self,
        id,
        sid,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/requests/{id}/signers/{sid}/signature',
    ...
    def resend_signing_link(
        ...
        _param = self._resend_signing_link_serialize(
            id=id,
            sid=sid,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ResendSigningLink200Response",
            '409': "Error",
            '400': "Error",
            '401': "Error",
            '404': "Error",
    ...
    @validate_call
    def resend_signing_link_with_http_info(
        self,
        id: Annotated[UUID, Field(description="Request ID")],
        sid: Annotated[UUID, Field(description="Signer ID")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ResendSigningLink200Response]:
        """Resend signing link
    ...
    @validate_call
    def resend_signing_link_without_preload_content(
        self,
        id: Annotated[UUID, Field(description="Request ID")],
        sid: Annotated[UUID, Field(description="Signer ID")],
        _request_timeout: Union[
    ...
    def _resend_signing_link_serialize(
        self,
        id,
        sid,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/requests/{id}/signers/{sid}/resend',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
