...
class AccountLimits(BaseModel):
    ...
    AccountLimits
    """ # noqa: E501
    requests_per_month: StrictInt = Field(description="-1 means unlimited")
    signing_requests_per_month: StrictInt = Field(description="-1 means unlimited")
    max_templates: StrictInt = Field(description="-1 means unlimited")
    max_members: StrictInt = Field(description="-1 means unlimited")
    __properties: ClassVar[List[str]] = ["requests_per_month", "signing_requests_per_month", "max_templates", "max_members"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "signing_requests_per_month": obj.get("signing_requests_per_month"),
            "max_templates": obj.get("max_templates"),
