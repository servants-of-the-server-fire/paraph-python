...
class CreateWebhook201ResponseWebhook(BaseModel):
    ...
    created_at: datetime
    updated_at: datetime
    secret: Optional[StrictStr] = Field(default=None, description="HMAC secret for verifying webhook deliveries. Only returned once, when the webhook is created. Store it securely. ")
    __properties: ClassVar[List[str]] = ["id", "url", "events", "active", "created_at", "updated_at", "secret"]
