...
class Account(BaseModel):
    ...
    team_name: StrictStr
    plan: StrictStr
    sandbox_mode: StrictBool = Field(description="Team-wide sandbox toggle. When true, every request from this team (web or API) is treated as sandbox regardless of which key is used — plan quotas are bypassed and PDFs get a SAMPLE watermark. ")
    api_key_name: StrictStr = Field(description="Name of the API key used for this request")
    api_key_sandbox: StrictBool = Field(description="Whether the API key used for this request is a sandbox key. Sandbox keys are always in sandbox regardless of `sandbox_mode`. A request is effectively sandbox when either flag is true. Mode is set at key creation time and cannot be changed. ")
    limits: AccountLimits
    usage: AccountUsage
    __properties: ClassVar[List[str]] = ["team_name", "plan", "sandbox_mode", "api_key_name", "api_key_sandbox", "limits", "usage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "api_key_sandbox": obj.get("api_key_sandbox"),
