...
class SignerInput(BaseModel):
    ...
    override_signature_url: Optional[StrictStr] = Field(default=None, description="URL to a PNG signature image. When provided, the image is downloaded and stored, the signer is immediately marked as signed, and no signing email is sent. ")
    __properties: ClassVar[List[str]] = ["email", "override_signature_url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "email": obj.get("email"),
            "override_signature_url": obj.get("override_signature_url")
        })
        return _obj
