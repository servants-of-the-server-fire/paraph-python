...
class SignaturePlacement(BaseModel):
    ...
    """ # noqa: E501
    id: UUID
    signer_label: Annotated[str, Field(strict=True, max_length=128)] = Field(description="Label identifying which signer this placement belongs to")
    page_number: StrictInt
    x: Union[StrictFloat, StrictInt] = Field(description="X coordinate in PDF points from the left edge of the page")
    y: Union[StrictFloat, StrictInt] = Field(description="Y coordinate in PDF points from the bottom edge of the page")
    width: Union[StrictFloat, StrictInt]
    height: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["id", "signer_label", "page_number", "x", "y", "width", "height"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "signer_label": obj.get("signer_label"),
