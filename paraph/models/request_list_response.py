...
class RequestListResponse(BaseModel):
    ...
    RequestListResponse
    """ # noqa: E501
    requests: Optional[List[DocumentRequestSummary]] = None
    list_info: Optional[ListInfo] = None
    __properties: ClassVar[List[str]] = ["requests", "list_info"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [DocumentRequestSummary.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None,
            "list_info": ListInfo.from_dict(obj["list_info"]) if obj.get("list_info") is not None else None
        })
        return _obj
