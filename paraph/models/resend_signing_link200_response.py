...
class ResendSigningLink200Response(BaseModel):
    """
    ResendSigningLink200Response
    """ # noqa: E501
    signer: Optional[Signer] = None
    __properties: ClassVar[List[str]] = ["signer"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResendSigningLink200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResendSigningLink200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "signer": Signer.from_dict(obj["signer"]) if obj.get("signer") is not None else None
        })
        return _obj
