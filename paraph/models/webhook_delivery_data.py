...
class WebhookDeliveryData(BaseModel):
    ...
    signer_id: Optional[UUID] = Field(default=None, description="Present for signer.* events")
    signer_label: Optional[StrictStr] = Field(default=None, description="Present for signer.* events")
    recipient_email: Optional[StrictStr] = Field(default=None, description="Present for signer.* events")
    __properties: ClassVar[List[str]] = ["request_id", "template_id", "signer_id", "signer_label", "recipient_email"]
