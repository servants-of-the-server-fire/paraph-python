...
class SignaturePlacementInput(BaseModel):
    """
    SignaturePlacementInput
    """ # noqa: E501
    signer_label: Annotated[str, Field(strict=True, max_length=128)]
    ...
    __properties: ClassVar[List[str]] = ["signer_label", "page_number", "x", "y", "width", "height"]
