...
class DocumentRequest(BaseModel):
    ...
    id: UUID
    template_id: UUID
    title: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Display title for the request")
    message: Optional[Annotated[str, Field(strict=True, max_length=1024)]] = Field(default=None, description="Custom message included in signing emails")
    status: RequestStatus
    has_signing: StrictBool = Field(description="Whether this request includes signers")
    created_at: datetime
    updated_at: datetime
    inputs: Optional[Dict[str, StrictStr]] = Field(default=None, description="Field values used to fill the template")
    ...
    signers: Optional[List[Signer]] = Field(default=None, description="Signers attached to this request, if any")
    __properties: ClassVar[List[str]] = ["id", "template_id", "title", "message", "status", "has_signing", "created_at", "updated_at", "inputs", "metadata", "signers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "has_signing": obj.get("has_signing"),
