...
class Signer(BaseModel):
    ...
    """ # noqa: E501
    id: UUID
    signer_label: StrictStr = Field(description="Role label for this signer (e.g. \"Employee\", \"Manager\")")
    recipient_email: StrictStr
    status: SignerStatus
    expires_at: Optional[datetime] = Field(default=None, description="When the signing link expires")
    signed_at: Optional[datetime] = Field(default=None, description="When the signer completed signing")
    __properties: ClassVar[List[str]] = ["id", "signer_label", "recipient_email", "status", "expires_at", "signed_at"]
