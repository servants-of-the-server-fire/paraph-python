...
class AccountUsage(BaseModel):
    ...
    AccountUsage
    """ # noqa: E501
    requests: StrictInt = Field(description="Requests created in the last 30 days")
    signing_requests: StrictInt = Field(description="Signing tasks created in the last 30 days")
    templates: StrictInt = Field(description="Total templates in the account")
    members: StrictInt = Field(description="Total team members")
    __properties: ClassVar[List[str]] = ["requests", "signing_requests", "templates", "members"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "signing_requests": obj.get("signing_requests"),
