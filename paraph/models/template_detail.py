...
class TemplateDetail(BaseModel):
    ...
    created_at: datetime
    updated_at: datetime
    fields: List[ModelField] = Field(description="Form fields detected in the uploaded PDF")
    signature_placements: List[SignaturePlacement] = Field(description="Signature placement regions configured on this template")
    __properties: ClassVar[List[str]] = ["id", "name", "metadata", "created_at", "updated_at", "fields", "signature_placements"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "signature_placements": [SignaturePlacement.from_dict(_item) for _item in obj["signature_placements"]] if obj.get("signature_placements") is not None else None
        })
        return _obj
